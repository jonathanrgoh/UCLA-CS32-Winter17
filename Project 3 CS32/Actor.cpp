...
: Alien(ptr, id, level , worth), m_state(0), m_canAct(true), flightPlan(0), dirX(-1), dirY(0)
{
...
: Alien(ptr, IID_SNAGGLEGON, 12 * ((level * .1 + .9)), 1000), m_canAct(true), m_justHit(false),dirY(1.75)
{
    setSize(1.5);
}
